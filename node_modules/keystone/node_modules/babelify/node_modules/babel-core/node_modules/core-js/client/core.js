...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.P, 'Array', {
	  ...
	  indexOf: indexOf = indexOf || __webpack_require__(69)(false),
	...
	$def($def.P, 'String', {trim: __webpack_require__(70)(/^\s*([\s\S]*\S)?\s*$/, '$1')});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if($.FW && $.DESC){
	  ...
	  if(/./g.flags != 'g')$.setDesc(proto, 'flags', {
	    configurable: true,
	    get: __webpack_require__(70)(/^.*\/(\w*)$/, '$1')
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(62);
	$def($def.S, 'RegExp', {
	  escape: __webpack_require__(70)(/([\\\-[\]{}()*+?.,^$|])/g, '\\$1', true)
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def     = __webpack_require__(62)
	  , replacer = __webpack_require__(70);
	var escapeHTMLDict = {
	  '&': '&amp;',
	  '<': '&lt;',
	  '>': '&gt;',
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.G + $def.F, {log: __webpack_require__(71)(log.log, log, {
	  enable: function(){
	    enabled = true;
	  },
	  disable: function(){
